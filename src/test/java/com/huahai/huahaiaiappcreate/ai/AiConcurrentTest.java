...
public class AiConcurrentTest {
    ...
    @Resource
    private AiCodeGeneratorTypeRoutingServiceFactory routingServiceFactory;
    ...
    public void testConcurrentRoutingCalls() throws InterruptedException {
        ...
        for (int i = 0; i < prompts.length; i++) {
            ...
            threads[i] = Thread.ofVirtual().start(() -> {
                AiCodeGeneratorTypeRoutingService service = routingServiceFactory.createAiCodeGenTypeRoutingService();
                var result = service.getCodeGenTypeRouting(prompt);
